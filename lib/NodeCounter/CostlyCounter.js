...
var CostlyCounter = /** @class */ (function (_super) {
    ...
    CostlyCounter.prototype.watch = function () {
        ...
        this.log("%4d ticks in %4d msec (expected %4d) => Ticks/minute: %5d, diff %3d. Lag per loop: %6.2f, Time per loop: %6d", tickCount, clockMsec, expectedLapMsec, ticksPerMin, diffMsec, lag, individualLapMsec);
        this.tickCount = 0;
        this.setLastPoll({
            clockMsec: clockMsec,
            diffMsec: diffMsec,
