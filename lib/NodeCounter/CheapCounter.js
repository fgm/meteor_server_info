...
var CheapCounter = /** @class */ (function (_super) {
     ...
     * @inheritDoc
     */
    CheapCounter.prototype.getDescription = function () {
     ...
     * @inheritDoc
     */
    CheapCounter.prototype.getInfo = function () {
        var polled = this.getLastPoll();
        // The value in .seconds is known to be a small int.
        polled.loopDelay = polled.loopDelay.seconds + polled.loopDelay.nanosec / 1E9;
        return polled;
    };
    /**
     * @inheritDoc
     ...
     * @inheritDoc
     */
    CheapCounter.prototype.poll = function () {
