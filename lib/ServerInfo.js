...
var _NodeInfo = require("./NodeInfo");
  ...
  _createClass(ServerInfo, [{
    ...
    value: function getInformation() {
      var sources = {
        ...
        "process": new _NodeInfo2.default(process, this.store.process)
      };
    ...
    value: function register() {
      var basicAuth = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    ...
    value: function getDescriptions() {
      var descriptions = {
        ...
        "process": _NodeInfo2.default.getDescription()
      };
