...
var ServerInfo = function () {
  ...
  _createClass(ServerInfo, [{
    ...
    value: function getConnectionCounts() {
      ...
      results.sessions = new _SessionInfo2.default(this.meteor.default_server.sessions).getInfo();
      results.mongo = new _MongoInfo2.default(this.mongoInternals).getInfo();
